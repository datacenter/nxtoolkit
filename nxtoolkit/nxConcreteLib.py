...
class ConcreteVpc(BaseNXPhysObject):
    """
...
class ConcreteVpcIf(BaseNXPhysObject):
    """
...
class ConcreteContext(BaseNXPhysObject):
    """
...
class ConcreteSVI(BaseNXPhysObject):
    """
    ...
    @staticmethod
    def get_table(nx_objects, title=''):
        """
        ...
        for nx_object in nx_objects:
            data.append([
                nx_object.attr.get('name', ''),
                nx_object.attr.get('id', ''),
                nx_object.attr.get('vlan_id', ''),
                nx_object.attr.get('mac', ''),
                nx_object.attr.get('bw', ''),
                nx_object.attr.get('admin_st', ''),
                nx_object.attr.get('oper_st', ''),
                nx_object.attr.get('oper_st_qual', '')
            ])
...
class ConcreteLoopback(BaseNXPhysObject):
    """
...
class ConcreteBD(BaseNXPhysObject):
    """
...
class ConcreteAccCtrlRule(BaseNXPhysObject):
    """
    ...
    def get(cls, top, parent=None):
        ...
        epgs = NX.EPG.get(top.session)
        contexts = NX.Context.get(top.session)
    ...
    def _get_tenant_context(self, contexts):
        ...
        and context
        """
        # contexts = NX.Context.get(session)
...
class ConcreteFilter(BaseNXPhysObject):
    """
...
class ConcreteFilterEntry(BaseNXPhysObject):
    """
...
class ConcreteEp(BaseNXPhysObject):
    """
...
class ConcretePortChannel(BaseNXPhysObject):
    """
...
class ConcreteOverlay(BaseNXPhysObject):
    """
